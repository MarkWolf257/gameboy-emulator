...
// Functions CB prefix
static inline void sla_r8(register8_t *r8, const char *name)
{
  cf = *r8 >> 7;
  *r8 <<= 1;
  zf = !(*r8);
...
static inline void swap_r8(register8_t *r8, const char *name)
{
  *r8 = *r8 << 4 | *r8 >> 4;
  zf = !(*r8);
  nf = 0; hf = 0; cf = 0;
...
static inline void bit_bitn_r8(uint8_t n, register8_t r8, const char *name)
{
  zf = !((r8 >> n) & 1);
  nf = 0; hf = 1;
  cycle_count += 2;
